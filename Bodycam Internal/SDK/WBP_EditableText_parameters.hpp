...
public:
	...
	class FText                                   CallFunc_TextToLower_ReturnValue;                  // 0x00B0(0x0018)()
	class FText                                   CallFunc_TextToUpper_ReturnValue;                  // 0x00C8(0x0018)()
};
static_assert(alignof(WBP_EditableText_C_SetAppearance) == 0x000008, "Wrong alignment on WBP_EditableText_C_SetAppearance");
static_assert(sizeof(WBP_EditableText_C_SetAppearance) == 0x0000E0, "Wrong size on WBP_EditableText_C_SetAppearance");
...
static_assert(offsetof(WBP_EditableText_C_SetAppearance, K2Node_SwitchEnum_CmpSuccess) == 0x0000A8, "Member 'WBP_EditableText_C_SetAppearance::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WBP_EditableText_C_SetAppearance, CallFunc_TextToLower_ReturnValue) == 0x0000B0, "Member 'WBP_EditableText_C_SetAppearance::CallFunc_TextToLower_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_EditableText_C_SetAppearance, CallFunc_TextToUpper_ReturnValue) == 0x0000C8, "Member 'WBP_EditableText_C_SetAppearance::CallFunc_TextToUpper_ReturnValue' has a wrong offset!");
