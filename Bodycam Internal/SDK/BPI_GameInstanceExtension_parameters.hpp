...
{
public:
	TSoftObjectPtr<class UBP_SaveGameManager_C>   SaveGameManager;                                   // 0x0000(0x0030)(Parm, OutParm, HasGetValueTypeHash)
};
...
static_assert(sizeof(BPI_GameInstanceExtension_C_GetSaveGameManager) == 0x000030, "Wrong size on BPI_GameInstanceExtension_C_GetSaveGameManager");
...
{
public:
	TSoftObjectPtr<class UBP_SettingsManager_C>   SettingsManager;                                   // 0x0000(0x0030)(Parm, OutParm, HasGetValueTypeHash)
};
...
static_assert(sizeof(BPI_GameInstanceExtension_C_GetSettingsManager) == 0x000030, "Wrong size on BPI_GameInstanceExtension_C_GetSettingsManager");
