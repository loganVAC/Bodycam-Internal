...
void UWBP_SliderBase_C::OnOptionChanged__DelegateSignature(double CurrentValue_0, class UWBP_SliderBase_C* OptionsSlider)
{
	static class UFunction* Func = nullptr;
...
void UWBP_SliderBase_C::OnSetHighlightEffect(EWidgetStyleState HighlightState_0, bool bPlaySound)
{
	static class UFunction* Func = nullptr;
...
void UWBP_SliderBase_C::SetWidgetState(EWidgetStyleState WidgetState_0)
{
	static class UFunction* Func = nullptr;
