...
static_assert(sizeof(GroundedEntryState_AnimNotify_C_Received_Notify) == 0x000060, "Wrong size on GroundedEntryState_AnimNotify_C_Received_Notify");
...
static_assert(offsetof(GroundedEntryState_AnimNotify_C_Received_Notify, ReturnValue) == 0x000038, "Member 'GroundedEntryState_AnimNotify_C_Received_Notify::ReturnValue' has a wrong offset!");
static_assert(offsetof(GroundedEntryState_AnimNotify_C_Received_Notify, CallFunc_GetAnimInstance_ReturnValue) == 0x000040, "Member 'GroundedEntryState_AnimNotify_C_Received_Notify::CallFunc_GetAnimInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(GroundedEntryState_AnimNotify_C_Received_Notify, K2Node_DynamicCast_AsALS_Animation_BPI) == 0x000048, "Member 'GroundedEntryState_AnimNotify_C_Received_Notify::K2Node_DynamicCast_AsALS_Animation_BPI' has a wrong offset!");
static_assert(offsetof(GroundedEntryState_AnimNotify_C_Received_Notify, K2Node_DynamicCast_bSuccess) == 0x000058, "Member 'GroundedEntryState_AnimNotify_C_Received_Notify::K2Node_DynamicCast_bSuccess' has a wrong offset!");
