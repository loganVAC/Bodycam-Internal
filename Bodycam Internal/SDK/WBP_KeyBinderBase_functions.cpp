...
void UWBP_KeyBinderBase_C::OnSetHighlightEffect(EWidgetStyleState HighlightState_0, bool bPlaySound)
{
	static class UFunction* Func = nullptr;
...
void UWBP_KeyBinderBase_C::RemoveDuplicateBindingInSameContext(bool* bForceCancelKeyChange, bool* bDuplicateFound)
{
	static class UFunction* Func = nullptr;
...
void UWBP_KeyBinderBase_C::ReplaceBindingAtIndex(int32 Index_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_KeyBinderBase_C", "ReplaceBindingAtIndex");

	Params::WBP_KeyBinderBase_C_ReplaceBindingAtIndex Parms{};
...
void UWBP_KeyBinderBase_C::SetStyleOnKeyBinderButtonAtIndex(EWidgetStyleState Style, int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
void UWBP_KeyBinderBase_C::SetWidgetState(EWidgetStyleState WidgetState_0)
{
	static class UFunction* Func = nullptr;
