...
static_assert(sizeof(USteamCoreNetDriver) == 0x000860, "Wrong size on USteamCoreNetDriver");
...
{
public:
	bool                                          M_bIsPassthrough;                                  // 0x1E48(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USteamCoreNetConnection) == 0x001E50, "Wrong size on USteamCoreNetConnection");
static_assert(offsetof(USteamCoreNetConnection, M_bIsPassthrough) == 0x001E48, "Member 'USteamCoreNetConnection::M_bIsPassthrough' has a wrong offset!");
