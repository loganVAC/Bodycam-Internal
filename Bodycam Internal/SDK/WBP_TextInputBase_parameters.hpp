...
public:
	...
	class UBP_SettingsManager_C*                  K2Node_DynamicCast_AsBP_Settings_Manager;          // 0x0088(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0090(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_SetStringValue_Success;                   // 0x0091(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_TextInputBase_C_ApplySettingsValue) == 0x000098, "Wrong size on WBP_TextInputBase_C_ApplySettingsValue");
...
static_assert(offsetof(WBP_TextInputBase_C_ApplySettingsValue, CallFunc_GetText_ReturnValue) == 0x000058, "Member 'WBP_TextInputBase_C_ApplySettingsValue::CallFunc_GetText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_ApplySettingsValue, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue) == 0x000070, "Member 'WBP_TextInputBase_C_ApplySettingsValue::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_ApplySettingsValue, CallFunc_Conv_TextToString_ReturnValue) == 0x000078, "Member 'WBP_TextInputBase_C_ApplySettingsValue::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_ApplySettingsValue, K2Node_DynamicCast_AsBP_Settings_Manager) == 0x000088, "Member 'WBP_TextInputBase_C_ApplySettingsValue::K2Node_DynamicCast_AsBP_Settings_Manager' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_ApplySettingsValue, K2Node_DynamicCast_bSuccess_1) == 0x000090, "Member 'WBP_TextInputBase_C_ApplySettingsValue::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_ApplySettingsValue, CallFunc_SetStringValue_Success) == 0x000091, "Member 'WBP_TextInputBase_C_ApplySettingsValue::CallFunc_SetStringValue_Success' has a wrong offset!");
...
public:
	...
	class UWBP_MenuContainer_C*                   CallFunc_GetOwningContainer_OwningContainer_1;     // 0x00C8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_TextInputBase_C_ExecuteUbergraph_WBP_TextInputBase) == 0x0000D0, "Wrong size on WBP_TextInputBase_C_ExecuteUbergraph_WBP_TextInputBase");
...
static_assert(offsetof(WBP_TextInputBase_C_ExecuteUbergraph_WBP_TextInputBase, CallFunc_GetOwningContainer_OwningContainer) == 0x0000B8, "Member 'WBP_TextInputBase_C_ExecuteUbergraph_WBP_TextInputBase::CallFunc_GetOwningContainer_OwningContainer' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_ExecuteUbergraph_WBP_TextInputBase, K2Node_Event_IsDesignTime) == 0x0000C0, "Member 'WBP_TextInputBase_C_ExecuteUbergraph_WBP_TextInputBase::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_ExecuteUbergraph_WBP_TextInputBase, CallFunc_GetOwningContainer_OwningContainer_1) == 0x0000C8, "Member 'WBP_TextInputBase_C_ExecuteUbergraph_WBP_TextInputBase::CallFunc_GetOwningContainer_OwningContainer_1' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class UBP_SettingsManager_C>   CallFunc_GetSettingsManager_SettingsManager;       // 0x0040(0x0030)(HasGetValueTypeHash)
	class UObject*                                CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue; // 0x0070(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_GetStringValue_Success;                   // 0x0089(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_8A[0x6];                                       // 0x008A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CallFunc_GetStringValue_Value;                     // 0x0090(0x0010)(ZeroConstructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_TextInputBase_C_GetSettingsValue) == 0x0000B8, "Wrong size on WBP_TextInputBase_C_GetSettingsValue");
...
static_assert(offsetof(WBP_TextInputBase_C_GetSettingsValue, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue) == 0x000070, "Member 'WBP_TextInputBase_C_GetSettingsValue::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_GetSettingsValue, K2Node_SwitchEnum_CmpSuccess) == 0x000078, "Member 'WBP_TextInputBase_C_GetSettingsValue::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_GetSettingsValue, K2Node_DynamicCast_AsBP_Settings_Manager) == 0x000080, "Member 'WBP_TextInputBase_C_GetSettingsValue::K2Node_DynamicCast_AsBP_Settings_Manager' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_GetSettingsValue, K2Node_DynamicCast_bSuccess_1) == 0x000088, "Member 'WBP_TextInputBase_C_GetSettingsValue::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_GetSettingsValue, CallFunc_GetStringValue_Success) == 0x000089, "Member 'WBP_TextInputBase_C_GetSettingsValue::CallFunc_GetStringValue_Success' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_GetSettingsValue, CallFunc_GetStringValue_Value) == 0x000090, "Member 'WBP_TextInputBase_C_GetSettingsValue::CallFunc_GetStringValue_Value' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_GetSettingsValue, CallFunc_Conv_StringToText_ReturnValue_1) == 0x0000A0, "Member 'WBP_TextInputBase_C_GetSettingsValue::CallFunc_Conv_StringToText_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(WBP_TextInputBase_C_OnSetHighlightEffect, HighlightState_0) == 0x000000, "Member 'WBP_TextInputBase_C_OnSetHighlightEffect::HighlightState_0' has a wrong offset!");
...
public:
	...
	struct FFFontStyle                            CallFunc_GetFontStyleByName_FontStyle;             // 0x0060(0x0080)(HasGetValueTypeHash)
	...
	struct FLinearColor                           CallFunc_GetColorByName_Color_8;                   // 0x0100(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFFontStyle                            CallFunc_GetFontStyleByName_FontStyle_1;           // 0x0110(0x0080)(HasGetValueTypeHash)
	struct FFFontStyle                            K2Node_MakeStruct_FFontStyle;                      // 0x0190(0x0080)(HasGetValueTypeHash)
	struct FLinearColor                           CallFunc_GetColorByName_Color_9;                   // 0x0210(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           CallFunc_GetColorByName_Color_10;                  // 0x0220(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(WBP_TextInputBase_C_OverrideWidgetStyleFromConfig, CallFunc_GetFontStyleByName_FontStyle) == 0x000060, "Member 'WBP_TextInputBase_C_OverrideWidgetStyleFromConfig::CallFunc_GetFontStyleByName_FontStyle' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_OverrideWidgetStyleFromConfig, CallFunc_GetColorByName_Color_6) == 0x0000E0, "Member 'WBP_TextInputBase_C_OverrideWidgetStyleFromConfig::CallFunc_GetColorByName_Color_6' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_OverrideWidgetStyleFromConfig, CallFunc_GetColorByName_Color_7) == 0x0000F0, "Member 'WBP_TextInputBase_C_OverrideWidgetStyleFromConfig::CallFunc_GetColorByName_Color_7' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_OverrideWidgetStyleFromConfig, CallFunc_GetColorByName_Color_8) == 0x000100, "Member 'WBP_TextInputBase_C_OverrideWidgetStyleFromConfig::CallFunc_GetColorByName_Color_8' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_OverrideWidgetStyleFromConfig, CallFunc_GetFontStyleByName_FontStyle_1) == 0x000110, "Member 'WBP_TextInputBase_C_OverrideWidgetStyleFromConfig::CallFunc_GetFontStyleByName_FontStyle_1' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_OverrideWidgetStyleFromConfig, K2Node_MakeStruct_FFontStyle) == 0x000190, "Member 'WBP_TextInputBase_C_OverrideWidgetStyleFromConfig::K2Node_MakeStruct_FFontStyle' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_OverrideWidgetStyleFromConfig, CallFunc_GetColorByName_Color_9) == 0x000210, "Member 'WBP_TextInputBase_C_OverrideWidgetStyleFromConfig::CallFunc_GetColorByName_Color_9' has a wrong offset!");
static_assert(offsetof(WBP_TextInputBase_C_OverrideWidgetStyleFromConfig, CallFunc_GetColorByName_Color_10) == 0x000220, "Member 'WBP_TextInputBase_C_OverrideWidgetStyleFromConfig::CallFunc_GetColorByName_Color_10' has a wrong offset!");
...
static_assert(sizeof(WBP_TextInputBase_C_SetDefaultTextFromSettingsData) == 0x000068, "Wrong size on WBP_TextInputBase_C_SetDefaultTextFromSettingsData");
...
static_assert(offsetof(WBP_TextInputBase_C_SetDefaultTextFromSettingsData, CallFunc_Conv_StringToText_ReturnValue) == 0x000050, "Member 'WBP_TextInputBase_C_SetDefaultTextFromSettingsData::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
...
static_assert(alignof(WBP_TextInputBase_C_SetInputTextAppearence) == 0x000008, "Wrong alignment on WBP_TextInputBase_C_SetInputTextAppearence");
static_assert(sizeof(WBP_TextInputBase_C_SetInputTextAppearence) == 0x000098, "Wrong size on WBP_TextInputBase_C_SetInputTextAppearence");
...
static_assert(offsetof(WBP_TextInputBase_C_SetWidgetState, WidgetState_0) == 0x000000, "Member 'WBP_TextInputBase_C_SetWidgetState::WidgetState_0' has a wrong offset!");
