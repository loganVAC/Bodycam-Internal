...
static_assert(sizeof(ASteamCoreProGameMode) == 0x000378, "Wrong size on ASteamCoreProGameMode");
...
static_assert(sizeof(USteamCoreProVoice) == 0x0004A0, "Wrong size on USteamCoreProVoice");
