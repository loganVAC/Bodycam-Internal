...
// Function WBP_InputIcon.WBP_InputIcon_C.OverrideWidgetStyleFromConfig
// (Public, BlueprintCallable, BlueprintEvent)

void UWBP_InputIcon_C::OverrideWidgetStyleFromConfig()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_InputIcon_C", "OverrideWidgetStyleFromConfig");
