...
static_assert(offsetof(WBP_OptionsPickerSubButtonBase_C_SetSubButtonStyle, WidgetStyleState_0) == 0x000000, "Member 'WBP_OptionsPickerSubButtonBase_C_SetSubButtonStyle::WidgetStyleState_0' has a wrong offset!");
