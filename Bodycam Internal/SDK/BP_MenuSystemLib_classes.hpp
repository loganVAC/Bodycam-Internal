...
public:
	...
	void GetControlsValues(class UObject* __WorldContext, bool* bInvertSticks, bool* bInvertXAxis, bool* bInvertYAxis, double* XAxisSensitivity, double* YAxisSensitivity, bool* VibrationEnabled, bool* AutoLean, double* CameraShakeAxisSensivity, bool* EnableVoiceChat);
	...
	bool IsSameMappingName(class FName SearchName, class FName DefinedName, class UObject* __WorldContext);
