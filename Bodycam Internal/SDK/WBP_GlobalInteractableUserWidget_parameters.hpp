...
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget, K2Node_CustomEvent_KeyEvent) == 0x000008, "Member 'WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget::K2Node_CustomEvent_KeyEvent' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget, K2Node_CustomEvent_KeyEvent_9) == 0x000048, "Member 'WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget::K2Node_CustomEvent_KeyEvent_9' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget, K2Node_CustomEvent_bAnyKeyReleased) == 0x000088, "Member 'WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget::K2Node_CustomEvent_bAnyKeyReleased' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget, K2Node_CustomEvent_KeyEvent_8) == 0x000090, "Member 'WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget::K2Node_CustomEvent_KeyEvent_8' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget, K2Node_CustomEvent_KeyEvent_7) == 0x0000D0, "Member 'WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget::K2Node_CustomEvent_KeyEvent_7' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget, K2Node_CustomEvent_KeyEvent_6) == 0x000110, "Member 'WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget::K2Node_CustomEvent_KeyEvent_6' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget, K2Node_CustomEvent_KeyEvent_5) == 0x000150, "Member 'WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget::K2Node_CustomEvent_KeyEvent_5' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget, K2Node_CustomEvent_KeyEvent_4) == 0x000190, "Member 'WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget::K2Node_CustomEvent_KeyEvent_4' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget, K2Node_CustomEvent_KeyEvent_3) == 0x0001D0, "Member 'WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget::K2Node_CustomEvent_KeyEvent_3' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget, K2Node_CustomEvent_KeyEvent_2) == 0x000210, "Member 'WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget::K2Node_CustomEvent_KeyEvent_2' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget, K2Node_CustomEvent_KeyEvent_1) == 0x000250, "Member 'WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget::K2Node_CustomEvent_KeyEvent_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget, K2Node_Event_IsDesignTime) == 0x000290, "Member 'WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget, CallFunc_GetMenuSystemConfigFromLibrary_MenuSystemConfig) == 0x000298, "Member 'WBP_GlobalInteractableUserWidget_C_ExecuteUbergraph_WBP_GlobalInteractableUserWidget::CallFunc_GetMenuSystemConfigFromLibrary_MenuSystemConfig' has a wrong offset!");
...
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_GetAllowNavigation, bAllowNavigation_0) == 0x000000, "Member 'WBP_GlobalInteractableUserWidget_C_GetAllowNavigation::bAllowNavigation_0' has a wrong offset!");
...
static_assert(sizeof(WBP_GlobalInteractableUserWidget_C_GetOwningContainer) == 0x000030, "Wrong size on WBP_GlobalInteractableUserWidget_C_GetOwningContainer");
...
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_GetOwningContainer, CallFunc_Array_Get_Item) == 0x000018, "Member 'WBP_GlobalInteractableUserWidget_C_GetOwningContainer::CallFunc_Array_Get_Item' has a wrong offset!");
...
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_GetOwningContainer, CallFunc_IsValid_ReturnValue) == 0x000029, "Member 'WBP_GlobalInteractableUserWidget_C_GetOwningContainer::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_GetOwningContainer, CallFunc_Array_IsValidIndex_ReturnValue) == 0x00002A, "Member 'WBP_GlobalInteractableUserWidget_C_GetOwningContainer::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_GetOwningContainer, CallFunc_IsValid_ReturnValue_1) == 0x00002B, "Member 'WBP_GlobalInteractableUserWidget_C_GetOwningContainer::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
...
public:
	...
	struct FEnhancedActionKeyMapping              CallFunc_KeyToUINavigation_EnhancedActionKeyMapping; // 0x0240(0x0098)(ContainsInstancedReference)
	bool                                          CallFunc_KeyToUINavigation_bIsKeyPressed;          // 0x02D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_GetUserIndex_ReturnValue;                 // 0x0398(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_39C[0x4];                                      // 0x039C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEventReply                            CallFunc_Handled_ReturnValue_2;                    // 0x03A0(0x00B8)()
	struct FEventReply                            CallFunc_Unhandled_ReturnValue;                    // 0x0458(0x00B8)()
	struct FEventReply                            CallFunc_Handled_ReturnValue_3;                    // 0x0510(0x00B8)()
	bool                                          Temp_bool_Variable_1;                              // 0x05C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5C9[0x7];                                      // 0x05C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEventReply                            CallFunc_Unhandled_ReturnValue_1;                  // 0x05D0(0x00B8)()
	class UWBP_InteractableUserWidget_C*          K2Node_DynamicCast_AsWBP_Interactable_User_Widget; // 0x0688(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_InteractableMenu_C*                K2Node_DynamicCast_AsWBP_Interactable_Menu;        // 0x0698(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_MenuContainer_C*                   CallFunc_GetOwningContainer_OwningContainer_3;     // 0x06A8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWBP_MenuContainer_C*                   CallFunc_GetOwningContainer_OwningContainer_4;     // 0x06B0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_PassInputEventToOtherMenuLayer_InputHandled; // 0x06B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_PassInputEventToOtherMenuLayer_InputHandled_1; // 0x06B9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_6BA[0x6];                                      // 0x06BA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEventReply                            K2Node_Select_Default;                             // 0x06C0(0x00B8)()
	struct FEventReply                            K2Node_Select_Default_1;                           // 0x0778(0x00B8)()
};
...
static_assert(sizeof(WBP_GlobalInteractableUserWidget_C_KeyDown) == 0x000830, "Wrong size on WBP_GlobalInteractableUserWidget_C_KeyDown");
...
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_GetOwningContainer_OwningContainer) == 0x000138, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_GetOwningContainer_OwningContainer' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_GetOwningContainer_OwningContainer_1) == 0x000140, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_GetOwningContainer_OwningContainer_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_GetOwningContainer_OwningContainer_2) == 0x000148, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_GetOwningContainer_OwningContainer_2' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_GetKey_ReturnValue) == 0x000150, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_GetKey_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_Handled_ReturnValue) == 0x000168, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_Handled_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_GetKey_ReturnValue_1) == 0x000220, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_GetKey_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, Temp_bool_Variable) == 0x000238, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_KeyToUINavigation_UINavigation) == 0x000239, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_KeyToUINavigation_UINavigation' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_KeyToUINavigation_EnhancedActionKeyMapping) == 0x000240, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_KeyToUINavigation_EnhancedActionKeyMapping' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_KeyToUINavigation_bIsKeyPressed) == 0x0002D8, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_KeyToUINavigation_bIsKeyPressed' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, K2Node_SwitchEnum_CmpSuccess) == 0x0002D9, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_Handled_ReturnValue_1) == 0x0002E0, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_Handled_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_GetUserIndex_ReturnValue) == 0x000398, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_GetUserIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_Handled_ReturnValue_2) == 0x0003A0, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_Handled_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_Unhandled_ReturnValue) == 0x000458, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_Unhandled_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_Handled_ReturnValue_3) == 0x000510, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_Handled_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, Temp_bool_Variable_1) == 0x0005C8, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_Unhandled_ReturnValue_1) == 0x0005D0, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_Unhandled_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, K2Node_DynamicCast_AsWBP_Interactable_User_Widget) == 0x000688, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::K2Node_DynamicCast_AsWBP_Interactable_User_Widget' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, K2Node_DynamicCast_bSuccess) == 0x000690, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, K2Node_DynamicCast_AsWBP_Interactable_Menu) == 0x000698, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::K2Node_DynamicCast_AsWBP_Interactable_Menu' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, K2Node_DynamicCast_bSuccess_1) == 0x0006A0, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_GetOwningContainer_OwningContainer_3) == 0x0006A8, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_GetOwningContainer_OwningContainer_3' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_GetOwningContainer_OwningContainer_4) == 0x0006B0, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_GetOwningContainer_OwningContainer_4' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_PassInputEventToOtherMenuLayer_InputHandled) == 0x0006B8, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_PassInputEventToOtherMenuLayer_InputHandled' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, CallFunc_PassInputEventToOtherMenuLayer_InputHandled_1) == 0x0006B9, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::CallFunc_PassInputEventToOtherMenuLayer_InputHandled_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, K2Node_Select_Default) == 0x0006C0, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyDown, K2Node_Select_Default_1) == 0x000778, "Member 'WBP_GlobalInteractableUserWidget_C_KeyDown::K2Node_Select_Default_1' has a wrong offset!");
...
public:
	...
	struct FEnhancedActionKeyMapping              CallFunc_KeyToMenuInputAction_EnhancedActionKeyMapping; // 0x0198(0x0098)(ContainsInstancedReference)
	bool                                          CallFunc_KeyToMenuInputAction_bIsKeyPressed;       // 0x0230(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_MenuContainer_C*                   CallFunc_GetOwningContainer_OwningContainer_5;     // 0x0238(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWBP_MenuContainer_C*                   CallFunc_GetOwningContainer_OwningContainer_6;     // 0x0240(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FEventReply                            CallFunc_Handled_ReturnValue;                      // 0x0248(0x00B8)()
	int32                                         CallFunc_GetUserIndex_ReturnValue;                 // 0x0300(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_304[0x4];                                      // 0x0304(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UWBP_MenuContainer_C*                   CallFunc_GetOwningContainer_OwningContainer_7;     // 0x0308(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FKey                                   CallFunc_GetKey_ReturnValue_2;                     // 0x0310(0x0018)(HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_GlobalInteractableUserWidget_C_KeyUp) == 0x000328, "Wrong size on WBP_GlobalInteractableUserWidget_C_KeyUp");
...
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_GetOwningContainer_OwningContainer) == 0x000130, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_GetOwningContainer_OwningContainer' has a wrong offset!");
...
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_GetOwningContainer_OwningContainer_1) == 0x000158, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_GetOwningContainer_OwningContainer_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_GetOwningContainer_OwningContainer_2) == 0x000160, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_GetOwningContainer_OwningContainer_2' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_GetOwningContainer_OwningContainer_3) == 0x000168, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_GetOwningContainer_OwningContainer_3' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_GetOwningContainer_OwningContainer_4) == 0x000170, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_GetOwningContainer_OwningContainer_4' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_GetKey_ReturnValue_1) == 0x000178, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_GetKey_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_KeyToMenuInputAction_MenuInputAction) == 0x000190, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_KeyToMenuInputAction_MenuInputAction' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_KeyToMenuInputAction_EnhancedActionKeyMapping) == 0x000198, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_KeyToMenuInputAction_EnhancedActionKeyMapping' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_KeyToMenuInputAction_bIsKeyPressed) == 0x000230, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_KeyToMenuInputAction_bIsKeyPressed' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, K2Node_SwitchEnum_CmpSuccess) == 0x000231, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_GetOwningContainer_OwningContainer_5) == 0x000238, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_GetOwningContainer_OwningContainer_5' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_GetOwningContainer_OwningContainer_6) == 0x000240, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_GetOwningContainer_OwningContainer_6' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_Handled_ReturnValue) == 0x000248, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_Handled_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_GetUserIndex_ReturnValue) == 0x000300, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_GetUserIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_GetOwningContainer_OwningContainer_7) == 0x000308, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_GetOwningContainer_OwningContainer_7' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_KeyUp, CallFunc_GetKey_ReturnValue_2) == 0x000310, "Member 'WBP_GlobalInteractableUserWidget_C_KeyUp::CallFunc_GetKey_ReturnValue_2' has a wrong offset!");
...
public:
	...
	struct FEnhancedActionKeyMapping              CallFunc_KeyToMenuInputAction_EnhancedActionKeyMapping; // 0x0208(0x0098)(ContainsInstancedReference)
	bool                                          CallFunc_KeyToMenuInputAction_bIsKeyPressed;       // 0x02A0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_MenuContainer_C*                   CallFunc_GetOwningContainer_OwningContainer_5;     // 0x0360(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWBP_MenuContainer_C*                   CallFunc_GetOwningContainer_OwningContainer_6;     // 0x0368(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWBP_MenuContainer_C*                   CallFunc_GetOwningContainer_OwningContainer_7;     // 0x0370(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_GlobalInteractableUserWidget_C_MouseButtonDown) == 0x000378, "Wrong size on WBP_GlobalInteractableUserWidget_C_MouseButtonDown");
...
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_MouseButtonDown, CallFunc_PointerEvent_GetUserIndex_ReturnValue) == 0x000180, "Member 'WBP_GlobalInteractableUserWidget_C_MouseButtonDown::CallFunc_PointerEvent_GetUserIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_MouseButtonDown, CallFunc_PointerEvent_GetEffectingButton_ReturnValue) == 0x000188, "Member 'WBP_GlobalInteractableUserWidget_C_MouseButtonDown::CallFunc_PointerEvent_GetEffectingButton_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_MouseButtonDown, K2Node_MakeStruct_InputChord) == 0x0001A0, "Member 'WBP_GlobalInteractableUserWidget_C_MouseButtonDown::K2Node_MakeStruct_InputChord' has a wrong offset!");
...
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_MouseButtonDown, CallFunc_KeyToMenuInputAction_bIsKeyPressed) == 0x0002A0, "Member 'WBP_GlobalInteractableUserWidget_C_MouseButtonDown::CallFunc_KeyToMenuInputAction_bIsKeyPressed' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_MouseButtonDown, K2Node_SwitchEnum_CmpSuccess) == 0x0002A1, "Member 'WBP_GlobalInteractableUserWidget_C_MouseButtonDown::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_MouseButtonDown, CallFunc_Handled_ReturnValue) == 0x0002A8, "Member 'WBP_GlobalInteractableUserWidget_C_MouseButtonDown::CallFunc_Handled_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_MouseButtonDown, CallFunc_GetOwningContainer_OwningContainer_5) == 0x000360, "Member 'WBP_GlobalInteractableUserWidget_C_MouseButtonDown::CallFunc_GetOwningContainer_OwningContainer_5' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_MouseButtonDown, CallFunc_GetOwningContainer_OwningContainer_6) == 0x000368, "Member 'WBP_GlobalInteractableUserWidget_C_MouseButtonDown::CallFunc_GetOwningContainer_OwningContainer_6' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_MouseButtonDown, CallFunc_GetOwningContainer_OwningContainer_7) == 0x000370, "Member 'WBP_GlobalInteractableUserWidget_C_MouseButtonDown::CallFunc_GetOwningContainer_OwningContainer_7' has a wrong offset!");
...
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_OnMouseMove, CallFunc_IsValid_ReturnValue) == 0x000174, "Member 'WBP_GlobalInteractableUserWidget_C_OnMouseMove::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
public:
	...
	TScriptInterface<class IBPI_GameInstanceExtension_C> K2Node_DynamicCast_AsBPI_Game_Instance_Extension_1; // 0x0118(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TSoftObjectPtr<class UBP_SettingsManager_C>   CallFunc_GetSettingsManager_SettingsManager_1;     // 0x0138(0x0030)(HasGetValueTypeHash)
	TScriptInterface<class IBPI_GameInstanceExtension_C> K2Node_DynamicCast_AsBPI_Game_Instance_Extension_2; // 0x0168(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UObject*                                CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_1; // 0x0180(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TSoftObjectPtr<class UBP_SettingsManager_C>   CallFunc_GetSettingsManager_SettingsManager_2;     // 0x0188(0x0030)(HasGetValueTypeHash)
	class UBP_SettingsManager_C*                  K2Node_DynamicCast_AsBP_Settings_Manager_1;        // 0x01B8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UBP_SettingsManager_C*                  K2Node_DynamicCast_AsBP_Settings_Manager_2;        // 0x01D0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FEnhancedActionKeyMapping              K2Node_MakeStruct_EnhancedActionKeyMapping;        // 0x0200(0x0098)(ContainsInstancedReference)
	class UGameInstance*                          CallFunc_GetGameInstance_ReturnValue_3;            // 0x0298(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UGameInstance*                          CallFunc_GetGameInstance_ReturnValue_4;            // 0x02A0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IBPI_GameInstanceExtension_C> K2Node_DynamicCast_AsBPI_Game_Instance_Extension_3; // 0x02A8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TScriptInterface<class IBPI_GameInstanceExtension_C> K2Node_DynamicCast_AsBPI_Game_Instance_Extension_4; // 0x02C0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TSoftObjectPtr<class UBP_SettingsManager_C>   CallFunc_GetSettingsManager_SettingsManager_3;     // 0x02D8(0x0030)(HasGetValueTypeHash)
	TSoftObjectPtr<class UBP_SettingsManager_C>   CallFunc_GetSettingsManager_SettingsManager_4;     // 0x0308(0x0030)(HasGetValueTypeHash)
	class UObject*                                CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_3; // 0x0338(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UObject*                                CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_4; // 0x0340(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UBP_SettingsManager_C*                  K2Node_DynamicCast_AsBP_Settings_Manager_3;        // 0x0348(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UBP_SettingsManager_C*                  K2Node_DynamicCast_AsBP_Settings_Manager_4;        // 0x0358(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_9;                     // 0x0360(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_LoadInputBindings_bSuccess;               // 0x0361(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_362[0x6];                                      // 0x0362(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FKey>                           CallFunc_Map_Values_Values_1;                      // 0x0368(0x0010)(ReferenceParm)
	struct FKey                                   CallFunc_Array_Get_Item_1;                         // 0x0378(0x0018)(HasGetValueTypeHash)
	TArray<class FName>                           CallFunc_Map_Keys_Keys_1;                          // 0x0390(0x0010)(ReferenceParm)
	class FName                                   CallFunc_Array_Get_Item_2;                         // 0x03A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings) == 0x000008, "Wrong alignment on WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings");
static_assert(sizeof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings) == 0x0003C0, "Wrong size on WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, TempCombinedInputBindings) == 0x000000, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::TempCombinedInputBindings' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, bRequireCreateNewConfigFile) == 0x000050, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::bRequireCreateNewConfigFile' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, Temp_int_Array_Index_Variable) == 0x000054, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, Temp_int_Loop_Counter_Variable) == 0x000058, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, Temp_int_Array_Index_Variable_1) == 0x00005C, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Add_IntInt_ReturnValue) == 0x000060, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_GetOwningPlayer_ReturnValue) == 0x000068, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Map_Keys_Keys) == 0x000070, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Map_Keys_Keys' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_GetComponentByClass_ReturnValue) == 0x000080, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Array_Get_Item) == 0x000088, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Array_Length_ReturnValue) == 0x000090, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Map_Remove_ReturnValue) == 0x000094, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Map_Remove_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Map_Values_Values) == 0x000098, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Map_Values_Values' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_GetGameInstance_ReturnValue) == 0x0000A8, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_GetGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_AsBPI_Game_Instance_Extension) == 0x0000B0, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_AsBPI_Game_Instance_Extension' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_bSuccess) == 0x0000C0, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_GetSettingsManager_SettingsManager) == 0x0000C8, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_GetSettingsManager_SettingsManager' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue) == 0x0000F8, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_GetGameInstance_ReturnValue_1) == 0x000100, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_GetGameInstance_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_AsBP_Settings_Manager) == 0x000108, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_AsBP_Settings_Manager' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_bSuccess_1) == 0x000110, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_AsBPI_Game_Instance_Extension_1) == 0x000118, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_AsBPI_Game_Instance_Extension_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_bSuccess_2) == 0x000128, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_GetGameInstance_ReturnValue_2) == 0x000130, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_GetGameInstance_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_GetSettingsManager_SettingsManager_1) == 0x000138, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_GetSettingsManager_SettingsManager_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_AsBPI_Game_Instance_Extension_2) == 0x000168, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_AsBPI_Game_Instance_Extension_2' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_bSuccess_3) == 0x000178, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_bSuccess_3' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_1) == 0x000180, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_GetSettingsManager_SettingsManager_2) == 0x000188, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_GetSettingsManager_SettingsManager_2' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_AsBP_Settings_Manager_1) == 0x0001B8, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_AsBP_Settings_Manager_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_bSuccess_4) == 0x0001C0, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_bSuccess_4' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_2) == 0x0001C8, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_AsBP_Settings_Manager_2) == 0x0001D0, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_AsBP_Settings_Manager_2' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_bSuccess_5) == 0x0001D8, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_bSuccess_5' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Map_Find_Value) == 0x0001E0, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Map_Find_ReturnValue) == 0x0001F8, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_MakeStruct_EnhancedActionKeyMapping) == 0x000200, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_MakeStruct_EnhancedActionKeyMapping' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_GetGameInstance_ReturnValue_3) == 0x000298, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_GetGameInstance_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_GetGameInstance_ReturnValue_4) == 0x0002A0, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_GetGameInstance_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_AsBPI_Game_Instance_Extension_3) == 0x0002A8, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_AsBPI_Game_Instance_Extension_3' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_bSuccess_6) == 0x0002B8, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_bSuccess_6' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_AsBPI_Game_Instance_Extension_4) == 0x0002C0, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_AsBPI_Game_Instance_Extension_4' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_bSuccess_7) == 0x0002D0, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_bSuccess_7' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_GetSettingsManager_SettingsManager_3) == 0x0002D8, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_GetSettingsManager_SettingsManager_3' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_GetSettingsManager_SettingsManager_4) == 0x000308, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_GetSettingsManager_SettingsManager_4' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_3) == 0x000338, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_4) == 0x000340, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_AsBP_Settings_Manager_3) == 0x000348, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_AsBP_Settings_Manager_3' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_bSuccess_8) == 0x000350, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_bSuccess_8' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_AsBP_Settings_Manager_4) == 0x000358, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_AsBP_Settings_Manager_4' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, K2Node_DynamicCast_bSuccess_9) == 0x000360, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::K2Node_DynamicCast_bSuccess_9' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_LoadInputBindings_bSuccess) == 0x000361, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_LoadInputBindings_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Map_Values_Values_1) == 0x000368, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Map_Values_Values_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Array_Get_Item_1) == 0x000378, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Map_Keys_Keys_1) == 0x000390, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Map_Keys_Keys_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Array_Get_Item_2) == 0x0003A0, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Array_Length_ReturnValue_1) == 0x0003A8, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Less_IntInt_ReturnValue) == 0x0003AC, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, Temp_int_Loop_Counter_Variable_1) == 0x0003B0, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Less_IntInt_ReturnValue_1) == 0x0003B4, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings, CallFunc_Add_IntInt_ReturnValue_1) == 0x0003B8, "Member 'WBP_GlobalInteractableUserWidget_C_RebuildCustomInputBindings::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
...
static_assert(alignof(WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault) == 0x000008, "Wrong alignment on WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault");
static_assert(sizeof(WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault) == 0x000068, "Wrong size on WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault, CallFunc_GetGameInstance_ReturnValue) == 0x000000, "Member 'WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault::CallFunc_GetGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault, K2Node_DynamicCast_AsBPI_Game_Instance_Extension) == 0x000008, "Member 'WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault::K2Node_DynamicCast_AsBPI_Game_Instance_Extension' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault, CallFunc_GetSettingsManager_SettingsManager) == 0x000020, "Member 'WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault::CallFunc_GetSettingsManager_SettingsManager' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue) == 0x000050, "Member 'WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault, K2Node_DynamicCast_AsBP_Settings_Manager) == 0x000058, "Member 'WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault::K2Node_DynamicCast_AsBP_Settings_Manager' has a wrong offset!");
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault, K2Node_DynamicCast_bSuccess_1) == 0x000060, "Member 'WBP_GlobalInteractableUserWidget_C_ResetInputBindingsToDefault::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
...
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_SetAllowNavigation, bAllowNavigation_0) == 0x000000, "Member 'WBP_GlobalInteractableUserWidget_C_SetAllowNavigation::bAllowNavigation_0' has a wrong offset!");
...
static_assert(sizeof(WBP_GlobalInteractableUserWidget_C_SetLastInteractingLocalPlayerIndex) == 0x000018, "Wrong size on WBP_GlobalInteractableUserWidget_C_SetLastInteractingLocalPlayerIndex");
...
static_assert(offsetof(WBP_GlobalInteractableUserWidget_C_SetLastInteractingLocalPlayerIndex, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'WBP_GlobalInteractableUserWidget_C_SetLastInteractingLocalPlayerIndex::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WBP_GlobalInteractableUserWidget_C_SetTextStyle) == 0x0000A0, "Wrong size on WBP_GlobalInteractableUserWidget_C_SetTextStyle");
