...
static_assert(sizeof(BP_SaveGameManager_C_GetLatestSaveGame) == 0x000060, "Wrong size on BP_SaveGameManager_C_GetLatestSaveGame");
...
static_assert(offsetof(BP_SaveGameManager_C_GetLatestSaveGame, Temp_int_Variable) == 0x000030, "Member 'BP_SaveGameManager_C_GetLatestSaveGame::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(BP_SaveGameManager_C_GetLatestSaveGame, CallFunc_Add_IntInt_ReturnValue) == 0x000034, "Member 'BP_SaveGameManager_C_GetLatestSaveGame::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SaveGameManager_C_GetLatestSaveGame, CallFunc_Conv_IntToString_ReturnValue) == 0x000038, "Member 'BP_SaveGameManager_C_GetLatestSaveGame::CallFunc_Conv_IntToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SaveGameManager_C_GetLatestSaveGame, CallFunc_Concat_StrStr_ReturnValue) == 0x000048, "Member 'BP_SaveGameManager_C_GetLatestSaveGame::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SaveGameManager_C_GetLatestSaveGame, CallFunc_DoesSaveGameExist_ReturnValue) == 0x000058, "Member 'BP_SaveGameManager_C_GetLatestSaveGame::CallFunc_DoesSaveGameExist_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SaveGameManager_C_GetLatestSaveGame, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000059, "Member 'BP_SaveGameManager_C_GetLatestSaveGame::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_SaveGameManager_C_LoadGame, SaveGameObject_0) == 0x000018, "Member 'BP_SaveGameManager_C_LoadGame::SaveGameObject_0' has a wrong offset!");
static_assert(offsetof(BP_SaveGameManager_C_LoadGame, CallFunc_GetLevelFromCustomSaveGameObject_LevelName) == 0x000020, "Member 'BP_SaveGameManager_C_LoadGame::CallFunc_GetLevelFromCustomSaveGameObject_LevelName' has a wrong offset!");
static_assert(offsetof(BP_SaveGameManager_C_LoadGame, CallFunc_LoadGameFromSlot_ReturnValue) == 0x000028, "Member 'BP_SaveGameManager_C_LoadGame::CallFunc_LoadGameFromSlot_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BP_SaveGameManager_C_LoadSaveMetaData) == 0x000048, "Wrong size on BP_SaveGameManager_C_LoadSaveMetaData");
...
static_assert(offsetof(BP_SaveGameManager_C_LoadSaveMetaData, SaveGameObject_0) == 0x000018, "Member 'BP_SaveGameManager_C_LoadSaveMetaData::SaveGameObject_0' has a wrong offset!");
static_assert(offsetof(BP_SaveGameManager_C_LoadSaveMetaData, SlotName1) == 0x000020, "Member 'BP_SaveGameManager_C_LoadSaveMetaData::SlotName1' has a wrong offset!");
static_assert(offsetof(BP_SaveGameManager_C_LoadSaveMetaData, CallFunc_Concat_StrStr_ReturnValue) == 0x000030, "Member 'BP_SaveGameManager_C_LoadSaveMetaData::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SaveGameManager_C_LoadSaveMetaData, CallFunc_LoadGameFromSlot_ReturnValue) == 0x000040, "Member 'BP_SaveGameManager_C_LoadSaveMetaData::CallFunc_LoadGameFromSlot_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_SaveGameManager_C_SetCustomSaveGameObject, SaveGameObject_0) == 0x000000, "Member 'BP_SaveGameManager_C_SetCustomSaveGameObject::SaveGameObject_0' has a wrong offset!");
