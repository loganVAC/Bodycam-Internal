...
bool UWBP_KeyBinderButtonBase_C::IsGamepadMapping(class FName InName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_KeyBinderButtonBase_C", "IsGamepadMapping");

	Params::WBP_KeyBinderButtonBase_C_IsGamepadMapping Parms{};
