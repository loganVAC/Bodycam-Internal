...
namespace Offsets
{
	constexpr int32 GObjects          = 0x07920660;
	constexpr int32 AppendString      = 0x02397E00;
	constexpr int32 GNames            = 0x0787A5C0;
	constexpr int32 GWorld            = 0x07A76F40;
	constexpr int32 ProcessEvent      = 0x0252C3B0;
