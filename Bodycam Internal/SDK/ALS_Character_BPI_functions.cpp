...
void IALS_Character_BPI_C::ApplyPointDamage(double Damage, double RagdollForce, class FName BoneName, const struct FVector& Location, const struct FVector& ShotFromDirection, class APlayerController* KillerPC, bool DisableHeadShot)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ALS_Character_BPI_C", "ApplyPointDamage");

	Params::ALS_Character_BPI_C_ApplyPointDamage Parms{};
...
// Function ALS_Character_BPI.ALS_Character_BPI_C.BPI_Death
// (Public, BlueprintCallable, BlueprintEvent)

void IALS_Character_BPI_C::BPI_Death()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ALS_Character_BPI_C", "BPI_Death");
...
void IALS_Character_BPI_C::BPI_Get_EssentialValues(struct FVector* Velocity, struct FVector* Acceleration, struct FVector* MovementInput, bool* IsMoving, bool* HasMovementInput, double* Speed, double* MovementInputAmount, struct FRotator* AimingRotation, double* AimYawRate)
{
	static class UFunction* Func = nullptr;
