...
// Parameters:
// class FText                             Username_0                                             (Parm, OutParm)
// class FText                             UsernameTricked                                        (Parm, OutParm)

void UW_PlayerInfo_C::GetUsername(class FText* Username_0, class FText* UsernameTricked)
{
	static class UFunction* Func = nullptr;
	...
	if (UsernameTricked != nullptr)
		*UsernameTricked = std::move(Parms.UsernameTricked);
}
