...
// class FString                           SlotName                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
// int32                                   UserIndex                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class USaveGame*                        SaveGameObject_0                                       (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UBP_SaveGameManager_C::LoadGame(const class FString& SlotName, int32 UserIndex, class USaveGame** SaveGameObject_0)
{
	static class UFunction* Func = nullptr;
	...
	if (SaveGameObject_0 != nullptr)
		*SaveGameObject_0 = Parms.SaveGameObject_0;
}
...
// class USaveGame*                        SaveGameObject_0                                       (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class FString                           SlotName1                                              (Parm, OutParm, ZeroConstructor, HasGetValueTypeHash)

void UBP_SaveGameManager_C::LoadSaveMetaData(const class FString& SlotName, const int32 UserIndex, class USaveGame** SaveGameObject_0, class FString* SlotName1)
{
	static class UFunction* Func = nullptr;
	...
	if (SlotName1 != nullptr)
		*SlotName1 = std::move(Parms.SlotName1);
}
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class USaveGame*                        SaveGameObject_0                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UBP_SaveGameManager_C::SetCustomSaveGameObject(class USaveGame* SaveGameObject_0)
{
	static class UFunction* Func = nullptr;
