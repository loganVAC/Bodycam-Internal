...
{
public:
	struct FRigUnit_RigLogic_Data                 Data;                                              // 0x0130(0x0088)(Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	bool                                          bIsInitialized;                                    // 0x01B8(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FRigUnit_RigLogic) == 0x0001C0, "Wrong size on FRigUnit_RigLogic");
static_assert(offsetof(FRigUnit_RigLogic, Data) == 0x000130, "Member 'FRigUnit_RigLogic::Data' has a wrong offset!");
static_assert(offsetof(FRigUnit_RigLogic, bIsInitialized) == 0x0001B8, "Member 'FRigUnit_RigLogic::bIsInitialized' has a wrong offset!");
