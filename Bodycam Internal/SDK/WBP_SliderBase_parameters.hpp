...
public:
	...
	TScriptInterface<class IBPI_GameInstanceExtension_C> K2Node_DynamicCast_AsBPI_Game_Instance_Extension_1; // 0x0068(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TSoftObjectPtr<class UBP_SettingsManager_C>   CallFunc_GetSettingsManager_SettingsManager_1;     // 0x0090(0x0030)(HasGetValueTypeHash)
	...
	double                                        CallFunc_ConvertUIValueToDataValue_ReturnValue;    // 0x00C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_ConvertUIValueToDataValue_ReturnValue_1;  // 0x00E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_SetFloatValue_Success;                    // 0x00F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_F1[0x7];                                       // 0x00F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TScriptInterface<class IBPI_GameInstanceExtension_C> K2Node_DynamicCast_AsBPI_Game_Instance_Extension_2; // 0x00F8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TSoftObjectPtr<class UBP_SettingsManager_C>   CallFunc_GetSettingsManager_SettingsManager_2;     // 0x0110(0x0030)(HasGetValueTypeHash)
	class UObject*                                CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_2; // 0x0140(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UBP_SettingsManager_C*                  K2Node_DynamicCast_AsBP_Settings_Manager_2;        // 0x0150(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_ConvertUIValueToDataValue_ReturnValue_2;  // 0x0160(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFValueTypes                           K2Node_MakeStruct_FValueTypes;                     // 0x0168(0x0028)(ZeroConstructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_SliderBase_C_ApplySettingsValue) == 0x000190, "Wrong size on WBP_SliderBase_C_ApplySettingsValue");
...
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, CallFunc_GetGameInstance_ReturnValue_1) == 0x000058, "Member 'WBP_SliderBase_C_ApplySettingsValue::CallFunc_GetGameInstance_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue) == 0x000060, "Member 'WBP_SliderBase_C_ApplySettingsValue::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, K2Node_DynamicCast_AsBPI_Game_Instance_Extension_1) == 0x000068, "Member 'WBP_SliderBase_C_ApplySettingsValue::K2Node_DynamicCast_AsBPI_Game_Instance_Extension_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, K2Node_DynamicCast_bSuccess_1) == 0x000078, "Member 'WBP_SliderBase_C_ApplySettingsValue::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, K2Node_DynamicCast_AsBP_Settings_Manager) == 0x000080, "Member 'WBP_SliderBase_C_ApplySettingsValue::K2Node_DynamicCast_AsBP_Settings_Manager' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, K2Node_DynamicCast_bSuccess_2) == 0x000088, "Member 'WBP_SliderBase_C_ApplySettingsValue::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, CallFunc_GetSettingsManager_SettingsManager_1) == 0x000090, "Member 'WBP_SliderBase_C_ApplySettingsValue::CallFunc_GetSettingsManager_SettingsManager_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_1) == 0x0000C0, "Member 'WBP_SliderBase_C_ApplySettingsValue::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, CallFunc_ConvertUIValueToDataValue_ReturnValue) == 0x0000C8, "Member 'WBP_SliderBase_C_ApplySettingsValue::CallFunc_ConvertUIValueToDataValue_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, K2Node_DynamicCast_AsBP_Settings_Manager_1) == 0x0000D0, "Member 'WBP_SliderBase_C_ApplySettingsValue::K2Node_DynamicCast_AsBP_Settings_Manager_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, K2Node_DynamicCast_bSuccess_3) == 0x0000D8, "Member 'WBP_SliderBase_C_ApplySettingsValue::K2Node_DynamicCast_bSuccess_3' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, CallFunc_ConvertUIValueToDataValue_ReturnValue_1) == 0x0000E0, "Member 'WBP_SliderBase_C_ApplySettingsValue::CallFunc_ConvertUIValueToDataValue_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, CallFunc_GetGameInstance_ReturnValue_2) == 0x0000E8, "Member 'WBP_SliderBase_C_ApplySettingsValue::CallFunc_GetGameInstance_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, CallFunc_SetFloatValue_Success) == 0x0000F0, "Member 'WBP_SliderBase_C_ApplySettingsValue::CallFunc_SetFloatValue_Success' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, K2Node_DynamicCast_AsBPI_Game_Instance_Extension_2) == 0x0000F8, "Member 'WBP_SliderBase_C_ApplySettingsValue::K2Node_DynamicCast_AsBPI_Game_Instance_Extension_2' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, K2Node_DynamicCast_bSuccess_4) == 0x000108, "Member 'WBP_SliderBase_C_ApplySettingsValue::K2Node_DynamicCast_bSuccess_4' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, CallFunc_GetSettingsManager_SettingsManager_2) == 0x000110, "Member 'WBP_SliderBase_C_ApplySettingsValue::CallFunc_GetSettingsManager_SettingsManager_2' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_2) == 0x000140, "Member 'WBP_SliderBase_C_ApplySettingsValue::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, K2Node_SwitchEnum_CmpSuccess) == 0x000148, "Member 'WBP_SliderBase_C_ApplySettingsValue::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, K2Node_DynamicCast_AsBP_Settings_Manager_2) == 0x000150, "Member 'WBP_SliderBase_C_ApplySettingsValue::K2Node_DynamicCast_AsBP_Settings_Manager_2' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, K2Node_DynamicCast_bSuccess_5) == 0x000158, "Member 'WBP_SliderBase_C_ApplySettingsValue::K2Node_DynamicCast_bSuccess_5' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, CallFunc_ConvertUIValueToDataValue_ReturnValue_2) == 0x000160, "Member 'WBP_SliderBase_C_ApplySettingsValue::CallFunc_ConvertUIValueToDataValue_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ApplySettingsValue, K2Node_MakeStruct_FValueTypes) == 0x000168, "Member 'WBP_SliderBase_C_ApplySettingsValue::K2Node_MakeStruct_FValueTypes' has a wrong offset!");
...
public:
	...
	class FText                                   K2Node_CustomEvent_Text_1;                         // 0x0020(0x0018)()
	ETextCommit                                   K2Node_CustomEvent_CommitMethod;                   // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   CallFunc_ConvertInputToNumeric_ModifiedText;       // 0x0060(0x0018)()
	...
	EWidgetStyleState                             K2Node_Event_HighlightState;                       // 0x00F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_bPlaySound;                           // 0x00F1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_SwitchEnum_CmpSuccess_1;                    // 0x00F2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_IsDesignTime;                         // 0x00F3(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_EqualEqual_ByteByte_ReturnValue_2;        // 0x00F6(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SetValueTextFromNumber_Value_ImplicitCast; // 0x00F8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase) == 0x000100, "Wrong size on WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase");
...
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, K2Node_CreateDelegate_OutputDelegate) == 0x000004, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000018, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, K2Node_CustomEvent_Text_1) == 0x000020, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::K2Node_CustomEvent_Text_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, K2Node_CustomEvent_CommitMethod) == 0x000038, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::K2Node_CustomEvent_CommitMethod' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, K2Node_CustomEvent_Text) == 0x000040, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::K2Node_CustomEvent_Text' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, K2Node_SwitchEnum_CmpSuccess) == 0x000058, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_ConvertInputToNumeric_ModifiedText) == 0x000060, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_ConvertInputToNumeric_ModifiedText' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_Conv_TextToString_ReturnValue) == 0x000078, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_Conv_TextToString_ReturnValue_1) == 0x000088, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_Conv_TextToString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_Conv_StringToDouble_ReturnValue) == 0x000098, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_Conv_StringToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_Left_ReturnValue) == 0x0000A0, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_Left_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_Conv_StringToText_ReturnValue) == 0x0000B0, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_IsValid_ReturnValue) == 0x0000C8, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, K2Node_CreateDelegate_OutputDelegate_1) == 0x0000CC, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, K2Node_Event_InFocusEvent) == 0x0000DC, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::K2Node_Event_InFocusEvent' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_K2_SetTimerDelegate_ReturnValue_1) == 0x0000E8, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_K2_SetTimerDelegate_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, K2Node_Event_HighlightState) == 0x0000F0, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::K2Node_Event_HighlightState' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, K2Node_Event_bPlaySound) == 0x0000F1, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::K2Node_Event_bPlaySound' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, K2Node_SwitchEnum_CmpSuccess_1) == 0x0000F2, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::K2Node_SwitchEnum_CmpSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, K2Node_Event_IsDesignTime) == 0x0000F3, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0000F4, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_EqualEqual_ByteByte_ReturnValue_1) == 0x0000F5, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_EqualEqual_ByteByte_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_EqualEqual_ByteByte_ReturnValue_2) == 0x0000F6, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_EqualEqual_ByteByte_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_EqualEqual_ByteByte_ReturnValue_3) == 0x0000F7, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_EqualEqual_ByteByte_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase, CallFunc_SetValueTextFromNumber_Value_ImplicitCast) == 0x0000F8, "Member 'WBP_SliderBase_C_ExecuteUbergraph_WBP_SliderBase::CallFunc_SetValueTextFromNumber_Value_ImplicitCast' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_GetFloatValue_Success;                    // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_79[0x7];                                       // 0x0079(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        CallFunc_GetFloatValue_Value;                      // 0x0080(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IBPI_GameInstanceExtension_C> K2Node_DynamicCast_AsBPI_Game_Instance_Extension_1; // 0x0088(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_ConvertDataValueToUIValue_UI_Value;       // 0x00A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TSoftObjectPtr<class UBP_SettingsManager_C>   CallFunc_GetSettingsManager_SettingsManager_1;     // 0x00A8(0x0030)(HasGetValueTypeHash)
	...
	class UBP_SettingsManager_C*                  K2Node_DynamicCast_AsBP_Settings_Manager_1;        // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_GetGameUserSettingsValue_Index;           // 0x00EC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_GetGameUserSettingsValue_Value;           // 0x00F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FString                                 CallFunc_GetGameUserSettingsValue_StringValue;     // 0x00F8(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	double                                        CallFunc_ConvertDataValueToUIValue_UI_Value_1;     // 0x0108(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_UpdateSliderProgressBarAndSliderHandle_Value_ImplicitCast; // 0x0110(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_SetValueTextFromNumber_Value_ImplicitCast; // 0x0114(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_SetValueTextFromNumber_Value_ImplicitCast_1; // 0x0118(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_SliderBase_C_GetSettingsValue) == 0x000008, "Wrong alignment on WBP_SliderBase_C_GetSettingsValue");
static_assert(sizeof(WBP_SliderBase_C_GetSettingsValue) == 0x000120, "Wrong size on WBP_SliderBase_C_GetSettingsValue");
...
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue) == 0x000058, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, K2Node_DynamicCast_AsBP_Settings_Manager) == 0x000060, "Member 'WBP_SliderBase_C_GetSettingsValue::K2Node_DynamicCast_AsBP_Settings_Manager' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, K2Node_DynamicCast_bSuccess_1) == 0x000068, "Member 'WBP_SliderBase_C_GetSettingsValue::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_GetGameInstance_ReturnValue_1) == 0x000070, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_GetGameInstance_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_GetFloatValue_Success) == 0x000078, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_GetFloatValue_Success' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_GetFloatValue_Value) == 0x000080, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_GetFloatValue_Value' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, K2Node_DynamicCast_AsBPI_Game_Instance_Extension_1) == 0x000088, "Member 'WBP_SliderBase_C_GetSettingsValue::K2Node_DynamicCast_AsBPI_Game_Instance_Extension_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, K2Node_DynamicCast_bSuccess_2) == 0x000098, "Member 'WBP_SliderBase_C_GetSettingsValue::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_ConvertDataValueToUIValue_UI_Value) == 0x0000A0, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_ConvertDataValueToUIValue_UI_Value' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_GetSettingsManager_SettingsManager_1) == 0x0000A8, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_GetSettingsManager_SettingsManager_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_1) == 0x0000D8, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, K2Node_DynamicCast_AsBP_Settings_Manager_1) == 0x0000E0, "Member 'WBP_SliderBase_C_GetSettingsValue::K2Node_DynamicCast_AsBP_Settings_Manager_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, K2Node_DynamicCast_bSuccess_3) == 0x0000E8, "Member 'WBP_SliderBase_C_GetSettingsValue::K2Node_DynamicCast_bSuccess_3' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_GetGameUserSettingsValue_Index) == 0x0000EC, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_GetGameUserSettingsValue_Index' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_GetGameUserSettingsValue_Value) == 0x0000F0, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_GetGameUserSettingsValue_Value' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_GetGameUserSettingsValue_StringValue) == 0x0000F8, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_GetGameUserSettingsValue_StringValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_ConvertDataValueToUIValue_UI_Value_1) == 0x000108, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_ConvertDataValueToUIValue_UI_Value_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_UpdateSliderProgressBarAndSliderHandle_Value_ImplicitCast) == 0x000110, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_UpdateSliderProgressBarAndSliderHandle_Value_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_SetValueTextFromNumber_Value_ImplicitCast) == 0x000114, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_SetValueTextFromNumber_Value_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_GetSettingsValue, CallFunc_SetValueTextFromNumber_Value_ImplicitCast_1) == 0x000118, "Member 'WBP_SliderBase_C_GetSettingsValue::CallFunc_SetValueTextFromNumber_Value_ImplicitCast_1' has a wrong offset!");
...
public:
	...
	struct FEnhancedActionKeyMapping              CallFunc_KeyToUINavigation_EnhancedActionKeyMapping; // 0x0210(0x0098)(ContainsInstancedReference)
	bool                                          CallFunc_KeyToUINavigation_bIsKeyPressed;          // 0x02A8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_SliderBase_C_OnKeyDown) == 0x0002B0, "Wrong size on WBP_SliderBase_C_OnKeyDown");
...
static_assert(offsetof(WBP_SliderBase_C_OnKeyDown, CallFunc_KeyToUINavigation_bIsKeyPressed) == 0x0002A8, "Member 'WBP_SliderBase_C_OnKeyDown::CallFunc_KeyToUINavigation_bIsKeyPressed' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_OnKeyDown, K2Node_SwitchEnum_CmpSuccess) == 0x0002A9, "Member 'WBP_SliderBase_C_OnKeyDown::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
...
static_assert(sizeof(WBP_SliderBase_C_OnKeyUp) == 0x0002B0, "Wrong size on WBP_SliderBase_C_OnKeyUp");
...
static_assert(offsetof(WBP_SliderBase_C_OnKeyUp, CallFunc_KeyToUINavigation_bIsKeyPressed) == 0x0002A8, "Member 'WBP_SliderBase_C_OnKeyUp::CallFunc_KeyToUINavigation_bIsKeyPressed' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_OnKeyUp, K2Node_SwitchEnum_CmpSuccess) == 0x0002A9, "Member 'WBP_SliderBase_C_OnKeyUp::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
...
static_assert(offsetof(WBP_SliderBase_C_OnOptionChanged__DelegateSignature, CurrentValue_0) == 0x000000, "Member 'WBP_SliderBase_C_OnOptionChanged__DelegateSignature::CurrentValue_0' has a wrong offset!");
...
static_assert(offsetof(WBP_SliderBase_C_OnSetHighlightEffect, HighlightState_0) == 0x000000, "Member 'WBP_SliderBase_C_OnSetHighlightEffect::HighlightState_0' has a wrong offset!");
...
public:
	...
	double                                        CallFunc_ConvertDataValueToUIValue_UI_Value;       // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_SliderBase_C_ResetSettingsValue) == 0x000080, "Wrong size on WBP_SliderBase_C_ResetSettingsValue");
...
static_assert(offsetof(WBP_SliderBase_C_ResetSettingsValue, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue) == 0x000060, "Member 'WBP_SliderBase_C_ResetSettingsValue::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ResetSettingsValue, K2Node_DynamicCast_AsBP_Settings_Manager) == 0x000068, "Member 'WBP_SliderBase_C_ResetSettingsValue::K2Node_DynamicCast_AsBP_Settings_Manager' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ResetSettingsValue, K2Node_DynamicCast_bSuccess_1) == 0x000070, "Member 'WBP_SliderBase_C_ResetSettingsValue::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_ResetSettingsValue, CallFunc_ConvertDataValueToUIValue_UI_Value) == 0x000078, "Member 'WBP_SliderBase_C_ResetSettingsValue::CallFunc_ConvertDataValueToUIValue_UI_Value' has a wrong offset!");
...
public:
	...
	float                                         CallFunc_SetValueTextFromNumber_Value_ImplicitCast; // 0x0080(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_UpdateSliderProgressBarAndSliderHandle_Value_ImplicitCast; // 0x0084(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_SetStepSize_InValue_ImplicitCast;         // 0x0088(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_SliderBase_C_SetupSliderInitial) == 0x000090, "Wrong size on WBP_SliderBase_C_SetupSliderInitial");
...
static_assert(offsetof(WBP_SliderBase_C_SetupSliderInitial, CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue) == 0x000058, "Member 'WBP_SliderBase_C_SetupSliderInitial::CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_SetupSliderInitial, K2Node_DynamicCast_AsBP_Settings_Manager) == 0x000060, "Member 'WBP_SliderBase_C_SetupSliderInitial::K2Node_DynamicCast_AsBP_Settings_Manager' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_SetupSliderInitial, K2Node_DynamicCast_bSuccess_1) == 0x000068, "Member 'WBP_SliderBase_C_SetupSliderInitial::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_SetupSliderInitial, CallFunc_ConvertDataValueToUIValue_UI_Value) == 0x000070, "Member 'WBP_SliderBase_C_SetupSliderInitial::CallFunc_ConvertDataValueToUIValue_UI_Value' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_SetupSliderInitial, CallFunc_FClamp_ReturnValue) == 0x000078, "Member 'WBP_SliderBase_C_SetupSliderInitial::CallFunc_FClamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_SetupSliderInitial, CallFunc_SetValueTextFromNumber_Value_ImplicitCast) == 0x000080, "Member 'WBP_SliderBase_C_SetupSliderInitial::CallFunc_SetValueTextFromNumber_Value_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_SetupSliderInitial, CallFunc_UpdateSliderProgressBarAndSliderHandle_Value_ImplicitCast) == 0x000084, "Member 'WBP_SliderBase_C_SetupSliderInitial::CallFunc_UpdateSliderProgressBarAndSliderHandle_Value_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_SetupSliderInitial, CallFunc_SetStepSize_InValue_ImplicitCast) == 0x000088, "Member 'WBP_SliderBase_C_SetupSliderInitial::CallFunc_SetStepSize_InValue_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(WBP_SliderBase_C_SetValueTextFromNumber) == 0x000028, "Wrong size on WBP_SliderBase_C_SetValueTextFromNumber");
...
static_assert(offsetof(WBP_SliderBase_C_SetValueTextFromNumber, CallFunc_Conv_DoubleToText_Value_ImplicitCast) == 0x000020, "Member 'WBP_SliderBase_C_SetValueTextFromNumber::CallFunc_Conv_DoubleToText_Value_ImplicitCast' has a wrong offset!");
...
static_assert(offsetof(WBP_SliderBase_C_SetWidgetState, WidgetState_0) == 0x000000, "Member 'WBP_SliderBase_C_SetWidgetState::WidgetState_0' has a wrong offset!");
...
static_assert(sizeof(WBP_SliderBase_C_UpdateSliderValue) == 0x000058, "Wrong size on WBP_SliderBase_C_UpdateSliderValue");
...
static_assert(offsetof(WBP_SliderBase_C_UpdateSliderValue, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000040, "Member 'WBP_SliderBase_C_UpdateSliderValue::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_UpdateSliderValue, CallFunc_NotEqual_DoubleDouble_ReturnValue) == 0x000048, "Member 'WBP_SliderBase_C_UpdateSliderValue::CallFunc_NotEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SliderBase_C_UpdateSliderValue, CallFunc_FClamp_ReturnValue) == 0x000050, "Member 'WBP_SliderBase_C_UpdateSliderValue::CallFunc_FClamp_ReturnValue' has a wrong offset!");
