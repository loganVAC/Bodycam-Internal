...
// class UObject*                          __WorldContext                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// struct FEnhancedActionKeyMapping        ActionMapping                                          (Parm, OutParm, ContainsInstancedReference)
...
// struct FEnhancedActionKeyMapping        EnhancedActionKeyMapping                               (Parm, OutParm, ContainsInstancedReference)
...
// bool                                    AutoLean                                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                                  CameraShakeAxisSensivity                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    EnableVoiceChat                                        (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_MenuSystemLib_C::GetControlsValues(class UObject* __WorldContext, bool* bInvertSticks, bool* bInvertXAxis, bool* bInvertYAxis, double* XAxisSensitivity, double* YAxisSensitivity, bool* VibrationEnabled, bool* AutoLean, double* CameraShakeAxisSensivity, bool* EnableVoiceChat)
{
	static class UFunction* Func = nullptr;
	...
	if (AutoLean != nullptr)
		*AutoLean = Parms.AutoLean;

	if (CameraShakeAxisSensivity != nullptr)
		*CameraShakeAxisSensivity = Parms.CameraShakeAxisSensivity;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// struct FEnhancedActionKeyMapping        EnhancedActionKeyMapping                               (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
// struct FKey                             PressedKey                                             (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
...
// class FName                             DefinedName                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UObject*                          __WorldContext                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

bool UBP_MenuSystemLib_C::IsSameMappingName(class FName SearchName, class FName DefinedName, class UObject* __WorldContext)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_MenuSystemLib_C", "IsSameMappingName");

	Params::BP_MenuSystemLib_C_IsSameMappingName Parms{};

	Parms.SearchName = SearchName;
	Parms.DefinedName = DefinedName;
	Parms.__WorldContext = __WorldContext;
